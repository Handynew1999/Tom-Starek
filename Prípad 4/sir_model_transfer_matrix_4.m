function [S1,I1,R1,S2,I2,R2,S3,I3,R3,R01,R02,R03,x1,x2,x3,y1,y2,y3,P1,P2,P3,P4,P5,P6,P7,P8,ti1,ti2,ti3,ti4,ti5,ti6,ti7,ti8,R021,R022] = sir_model_transfer_matrix_4(beta,gamma,N,I0,T,dt,delta)
    P=1;
    S1 = zeros(1,T/dt);
    S1(1) = (N(1)-I0(1))*(1-P);
    I1 = zeros(1,T/dt);
    ...
    for tt = 1:(T/dt)-1
        ...
        if I1(tt)/(S1(tt)+R1(tt))>=0.05 && opatrenie11==0
         opatrenie11=1;
         beta(1)=beta(1)*0.62; %0.62 %0.66 %0.665 %0.62
         P1=I1(tt);
         ti1=tt;
        end
