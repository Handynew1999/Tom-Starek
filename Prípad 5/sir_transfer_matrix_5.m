...
[S1,I1,R1,S2,I2,R2,S3,I3,R3,R01,R02,R03,x1,x2,x3,y1,y2,y3,P1,P2,P3,P4,P5,P6,P7,P8,ti1,ti2,ti3,ti4,ti5,ti6,ti7,ti8,R021,R022] = sir_model_transfer_matrix_5(beta,gamma,N,I0,T,dt,delta);
tt = 0:dt:T-dt;
subplot(2,2,1);
plot(tt,S1/N(1),tt,I1/N(1),tt,R1/N(1),'LineWidth',2); grid on; hold on;
plot(ti1,P1/N(1),'*'); hold off;
title('Rakúsko');
...
subplot(2,2,2);
plot(tt,S2/N(2),tt,I2/N(2),tt,R2/N(2),'LineWidth',2); grid on; 
title('Slovensko');
xlabel('Poèet dní'); ylabel('Poèet obyvate¾ov (%)');
legend('S2','I2','R2');
subplot(2,2,4);
